...
def test_local_linear():
    ...
    np.testing.assert_almost_equal(model.density(10.), d0, decimal=8)
    np.testing.assert_almost_equal(model.density(11.), dp, decimal=8)
    np.testing.assert_almost_equal(model.density(9.), dm, decimal=8)
    np.testing.assert_almost_equal(model.density(None), d0, decimal=8)
    expected = 0.5 * d0 + 0.5 * dp
    np.testing.assert_almost_equal(model.density(10.50), expected, decimal=8)
    expected = 0.8 * d0 + 0.2 * dp
    np.testing.assert_almost_equal(model.density(10.20), expected, decimal=8)
    expected = 0.25 * d0 + 0.75 * dp
    np.testing.assert_almost_equal(model.density(10.75), expected, decimal=8)
    expected = 0.5 * dm + 0.5 * d0
    np.testing.assert_almost_equal(model.density(9.50), expected, decimal=8)
    expected = 0.68 * dm + 0.32 * d0
    np.testing.assert_almost_equal(model.density(9.32), expected, decimal=8)
    expected = 0.39 * dm + 0.61 * d0
    np.testing.assert_almost_equal(model.density(9.61), expected, decimal=8)
    # Check descriptos
    expected = np.array([-0.5, 1.5, 1.0, -1.0, -2.0])
    np.testing.assert_almost_equal(model.ff_plus, expected, decimal=8)
    np.testing.assert_almost_equal(model.fukui_function(10.10), expected, decimal=8)
    np.testing.assert_almost_equal(model.fukui_function(10.73), expected, decimal=8)
    expected = np.array([0.0, -1.0, 2.0, 0.0, -1.0])
    np.testing.assert_almost_equal(model.ff_minus, expected, decimal=8)
    np.testing.assert_almost_equal(model.fukui_function(9.40), expected, decimal=8)
    np.testing.assert_almost_equal(model.fukui_function(9.95), expected, decimal=8)
    expected = np.array([-0.25, 0.25, 1.5, -0.5, -1.5])
    np.testing.assert_almost_equal(model.ff_zero, expected, decimal=8)
    np.testing.assert_almost_equal(model.fukui_function(None), expected, decimal=8)
...
def test_local_quadratic():
    ...
    np.testing.assert_almost_equal(model.density_plus, dp, decimal=8)
    np.testing.assert_almost_equal(model.density_minus, dm, decimal=8)
    np.testing.assert_almost_equal(model.density(5.), d0, decimal=8)
    np.testing.assert_almost_equal(model.density(6.), dp, decimal=8)
    np.testing.assert_almost_equal(model.density(4.), dm, decimal=8)
    np.testing.assert_almost_equal(model.density(None), d0, decimal=8)
    # Density
    expected = np.array([-0.25, 0.25, 1.5, -0.5, -1.5])
    np.testing.assert_almost_equal(model.fukui_function(None), expected, decimal=8)
    np.testing.assert_almost_equal(model.fukui_function(5.), expected, decimal=8)
    expected = np.array([-0.75, 2.75, 0.5, -1.5, -2.5])
    np.testing.assert_almost_equal(model.fukui_function(6.), expected, decimal=8)
    expected = np.array([0.25, -2.25, 2.5, 0.5, -0.5])
    np.testing.assert_almost_equal(model.fukui_function(4.), expected, decimal=8)
    expected = np.array([-0.3, 0.5, 1.4, -0.6, -1.6])
    np.testing.assert_almost_equal(model.fukui_function(5.1), expected, decimal=8)
    expected = np.array([-0.2, 0.0, 1.6, -0.4, -1.4])
    np.testing.assert_almost_equal(model.fukui_function(4.9), expected, decimal=8)
    # Dual Descriptor
