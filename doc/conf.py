...
def _git_tag_version(default='1.0.0'):
    try:
        ...
        return tag.decode('utf-8').strip().lstrip('v') or default
    except Exception:
        return default
...
# pixels large.
html_favicon = '_static/chemtools_favicon.ico'
...
htmlhelp_basename = 'ChemToolsdoc'
...
latex_documents = [
    (master_doc, 'ChemTools.tex', 'ChemTools Documentation',
     'ChemTools Dev Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'chemtools', 'ChemTools Documentation',
     [author], 1)
]
