...
def parse_args_nci():
    ...
    # optional arguments
    parser.add_argument('--cube', default='0.1,2.0', type=str, metavar='N',
    ...
    parser.add_argument('--plot', default=False, action='store_true',
                        help='plot reduced density gradient vs. signed density (density multiplied '
                             'by sign of hessian\'s 2nd eigenvalue). This generates a '
                             'output_name.png file. This plot is not affected by the value of '
                             'denscut argument. [default=%(default)s]')
    parser.add_argument('--isosurface', default=0.5, type=float,
                        help='iso-surface value of reduced density gradient (RDG) to visualize. '
                             '[default=%(default)s]')
    parser.add_argument('--denscut', default=0.05, type=float,
